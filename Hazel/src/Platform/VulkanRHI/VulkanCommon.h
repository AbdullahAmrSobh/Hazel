...
#include "Platform/VulkanRHI/vma/vma.h"
...
namespace Hazel
{
	inline std::string VkToString(VkResult result)
	{
		switch (result)
		{
	...
	#define VK_ASSERT(x, msg) HZ_CORE_ASSERT(x == VK_SUCCESS, std::string(msg) + " " +  VkToString(x));


	inline static VkFormat ConvertToVulkanFormat(RHIFormat format)
	{
